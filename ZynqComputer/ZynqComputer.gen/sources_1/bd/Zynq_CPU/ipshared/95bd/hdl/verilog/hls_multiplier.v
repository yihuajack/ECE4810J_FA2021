...
wire   [15:0] a;
wire   [15:0] b;
wire   [15:0] grp_fu_50_p0;
wire   [15:0] grp_fu_50_p1;
...
wire   [31:0] grp_fu_50_p00;
wire   [31:0] grp_fu_50_p10;
wire    ap_ce_reg;
wire   [31:0] ap_return;
...
hls_multiplier_mul_mul_16ns_16ns_32_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 16 ),
...
assign grp_fu_50_p00 = b;

assign grp_fu_50_p1 = grp_fu_50_p10;

assign grp_fu_50_p10 = a;
