...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((real_start == 1'b0) | (1'b0 == V_scale_c_full_n) | (1'b0 == U_scale_c_full_n) | (1'b0 == Y_scale_c_full_n) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (1'b0 == V_scale_c_full_n) | (1'b0 == U_scale_c_full_n) | (1'b0 == Y_scale_c_full_n) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((real_start == 1'b0) | (1'b0 == V_scale_c_full_n) | (1'b0 == U_scale_c_full_n) | (1'b0 == Y_scale_c_full_n) | (ap_done_reg == 1'b1))) begin
