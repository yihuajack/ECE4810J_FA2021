...
architecture behav of yuv_filter is 
    ...
    "yuv_filter_yuv_filter,hls_ip_2021_1_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.271000,HLS_SYN_LAT=784423,HLS_SYN_TPT=784415,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=2251,HLS_SYN_LUT=2717,HLS_VERSION=2021_1_1}";
    ...
    signal rgb2yuv_1_U0_out_channels_ch1_din : STD_LOGIC_VECTOR (7 downto 0);
    signal rgb2yuv_1_U0_out_channels_ch1_write : STD_LOGIC;
    signal rgb2yuv_1_U0_out_channels_ch2_din : STD_LOGIC_VECTOR (7 downto 0);
    signal rgb2yuv_1_U0_out_channels_ch2_write : STD_LOGIC;
    signal rgb2yuv_1_U0_out_channels_ch3_din : STD_LOGIC_VECTOR (7 downto 0);
    signal rgb2yuv_1_U0_out_channels_ch3_write : STD_LOGIC;
    signal rgb2yuv_1_U0_out_width_din : STD_LOGIC_VECTOR (15 downto 0);
    signal rgb2yuv_1_U0_out_width_write : STD_LOGIC;
    signal rgb2yuv_1_U0_out_height_din : STD_LOGIC_VECTOR (15 downto 0);
    signal rgb2yuv_1_U0_out_height_write : STD_LOGIC;
    ...
    signal yuv2rgb_1_U0_in_channels_ch1_read : STD_LOGIC;
    signal yuv2rgb_1_U0_in_channels_ch2_read : STD_LOGIC;
    signal yuv2rgb_1_U0_in_channels_ch3_read : STD_LOGIC;
    signal yuv2rgb_1_U0_in_width_read : STD_LOGIC;
    signal yuv2rgb_1_U0_in_height_read : STD_LOGIC;
...
begin
    ...
    port map (
        ...
        in_width => in_width,
        in_height => in_height,
        out_channels_ch1_din => rgb2yuv_1_U0_out_channels_ch1_din,
        out_channels_ch1_full_n => p_yuv_channels_ch1_full_n,
        out_channels_ch1_write => rgb2yuv_1_U0_out_channels_ch1_write,
        out_channels_ch2_din => rgb2yuv_1_U0_out_channels_ch2_din,
        out_channels_ch2_full_n => p_yuv_channels_ch2_full_n,
        out_channels_ch2_write => rgb2yuv_1_U0_out_channels_ch2_write,
        out_channels_ch3_din => rgb2yuv_1_U0_out_channels_ch3_din,
        out_channels_ch3_full_n => p_yuv_channels_ch3_full_n,
        out_channels_ch3_write => rgb2yuv_1_U0_out_channels_ch3_write,
        out_width_din => rgb2yuv_1_U0_out_width_din,
        out_width_full_n => p_yuv_width_full_n,
        out_width_write => rgb2yuv_1_U0_out_width_write,
        out_height_din => rgb2yuv_1_U0_out_height_din,
        out_height_full_n => p_yuv_height_full_n,
        out_height_write => rgb2yuv_1_U0_out_height_write);
    ...
    port map (
        ...
        start_full_n => start_for_yuv2rgb_1_U0_full_n,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => rgb2yuv_1_U0_out_channels_ch1_din,
        if_full_n => p_yuv_channels_ch1_full_n,
        if_write => rgb2yuv_1_U0_out_channels_ch1_write,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => rgb2yuv_1_U0_out_channels_ch2_din,
        if_full_n => p_yuv_channels_ch2_full_n,
        if_write => rgb2yuv_1_U0_out_channels_ch2_write,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => rgb2yuv_1_U0_out_channels_ch3_din,
        if_full_n => p_yuv_channels_ch3_full_n,
        if_write => rgb2yuv_1_U0_out_channels_ch3_write,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => rgb2yuv_1_U0_out_width_din,
        if_full_n => p_yuv_width_full_n,
        if_write => rgb2yuv_1_U0_out_width_write,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => rgb2yuv_1_U0_out_height_din,
        if_full_n => p_yuv_height_full_n,
        if_write => rgb2yuv_1_U0_out_height_write,
    ...
    port map (
        ...
        if_read => yuv2rgb_1_U0_in_channels_ch1_read);
    ...
    port map (
        ...
        if_read => yuv2rgb_1_U0_in_channels_ch2_read);
    ...
    port map (
        ...
        if_read => yuv2rgb_1_U0_in_channels_ch3_read);
    ...
    port map (
        ...
        if_read => yuv2rgb_1_U0_in_width_read);
    ...
    port map (
        ...
        if_read => yuv2rgb_1_U0_in_height_read);
