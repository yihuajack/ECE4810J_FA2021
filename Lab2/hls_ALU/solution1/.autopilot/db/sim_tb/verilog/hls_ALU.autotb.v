...
`define AUTOTB_DUT      hls_ALU
`define AUTOTB_DUT_INST AESL_inst_hls_ALU
`define AUTOTB_TOP      apatb_hls_ALU_top
`define AUTOTB_LAT_RESULT_FILE "hls_ALU.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "hls_ALU.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_hls_ALU_top
...
`define AUTOTB_TVIN_a  "./c.hls_ALU.autotvin_a.dat"
`define AUTOTB_TVIN_b  "./c.hls_ALU.autotvin_b.dat"
`define AUTOTB_TVIN_c  "./c.hls_ALU.autotvin_c.dat"
`define AUTOTB_TVIN_a_out_wrapc  "./rtl.hls_ALU.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "./rtl.hls_ALU.autotvin_b.dat"
`define AUTOTB_TVIN_c_out_wrapc  "./rtl.hls_ALU.autotvin_c.dat"
`define AUTOTB_TVOUT_ap_return  "./c.hls_ALU.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.hls_ALU.autotvout_ap_return.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    fp1 = $fopen("./rtl.hls_ALU.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.hls_ALU.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.hls_ALU.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.hls_ALU.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.hls_ALU.autotvout_ap_return.dat with impl_rtl.hls_ALU.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
