...
end entity hls_ALU_CRTLS_s_axi;
...
architecture behave of hls_ALU_CRTLS_s_axi is
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_C_DATA_0) then
                    int_c(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_c(15 downto 0));
                end if;
            end if;
        end if;
    end process;
