...
# ==============================================================
set ::env(PATH) "$::env(PATH);F:/Xilinx/Vitis_HLS/2021.1/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);F:/Xilinx/Vitis_HLS/2021.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);F:/Xilinx/Vitis_HLS/2021.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);F:/Xilinx/Vitis_HLS/2021.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hls_ALU.autotvin.dat"
	set constFileTvOut       "hls_ALU.autotvout.dat"
	set constFileHdlTvIn     "hls_ALU.autohdltvin.dat"
	set constFileHdlTvOut    "hls_ALU.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
